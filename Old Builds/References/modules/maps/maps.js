...
import { setupEnemyWaves } from '../managers/enemyManager.js'
import { EnergyCrystalTower } from '../towers/uniqueTowers.js';
...
export function canBuildHere(x, y, towerType) {
    ...
    if (blocker) {
        ...
        if (blocker.buildable === "crystalOnly" && towerType !== EnergyCrystalTower) {
            return false;
        }
    }
